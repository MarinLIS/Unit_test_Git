...
import src.seminars.first.Calculator.Calculator;
...
//        assert 10 == Calculator.calculation(2, 6, '+');
//        assert 0 == Calculator.calculation(2, 2, '-');
//        assert 14 == Calculator.calculation(2, 7, '*');
//        assert 2 == Calculator.calculation(100, 50, '/');

//        // Проверка базового функционала с целыми числами, с использованием утверждений AssertJ:
//        assertThat(Calculator.calculation(2, 6, '+')).isEqualTo(10);
...
//        System.out.println(Calculator.squareRootExtraction(123456789789));
//         assertThatThrownBy(() -> // не работает
...
//            assertThat(Calculator.calculation(5, 0, '/')).isInstanceOf(ArithmeticException.class);
//         assertThatThrownBy(() ->
//                src.seminars.first.Calculator.Calculator.calculation(5, 0, '/')
...
//         if (0 != src.seminars.first.Calculator.Calculator.calculation(2, 6, '+')) {
//             throw new AssertionError("Ошибка в методе");
//         }
//           assert 0 == src.seminars.first.Calculator.Calculator.calculation(2, 6, '+');
//            assertThat(src.seminars.first.Calculator.Calculator.calculation(2, 6, '+')).isEqualTo(0);
//    }
//        HW1.4: СВ классе Calculator создайте метод calculateDiscount,
...
//        Не забудьте написать тесты для проверки этого поведения.
        System.out.println(Calculator.calculatingDiscount(100, -10));
            assertThat(Calculator.calculatingDiscount(100, -15)).isInstanceOf(ArithmeticException.class);
